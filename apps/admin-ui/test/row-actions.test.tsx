...
describe('the two that are one click', () => {
...
describe('the menu', () => {
  ...
  it('is absent when there is nothing to put in it', async () => {
    // No delete, no declared actions: a menu button that opens an empty menu
